                ...
                <div class="d-grid col-9 mx-auto btn">
                    <div class="accordion" id="collapse-buttons">
                        <div class="accordion-item">
                            ...
                            <div id="description" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#collapse-buttons">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="price" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#collapse-buttons">
                                <div class="accordion-body">
                                    <div class="col-6 text-start mx-auto mb-4">
                                        <p class="m-0 mt-2">₱ 350 - 1 CHARACTER</p>
                                        <p class="m-0">₱ 480 - 2 CHARACTERS</p>
                                    </div>
                                    <div class="col-10 text-start mx-auto">
                                        <p class="m-0 fw-bold text-center me-4">Add-ons</p>
                                        <p class="m-0">+ ₱ 30 ADDITIONA CHARACTERS</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="shipping-info" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#collapse-buttons">
                                <div class="accordion-body">
                ...
                <div class="body ms-2">
                    ...
                    <div class="d-grid col-3 upload">
                        ...
                        <form action="">
                          ...
                          -->
                        <button type="file" class="py-1"><i class="fas fa-upload me-3"></i>Upload</button>
                    </div>
                </div>
