                    ...
                    <div class="accordion-item">
                        ...
                        <div id="product" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#product-collapse">
                                    ...
                                    <ul class="mb-0">
                                        <li>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="../staff-product/updateproduct.php?productname=<?php echo $row['product_name']; ?>"
                            ...
                            <div class="d-grid col-8 mx-auto px-0 btn btn-shadow" style="background: rgba(209, 209, 209, 0.77);color:#000">
                                <a class="text-reset text-decoration-none" data-parent="#product" href="../staff-product/addproduct.php">+ add product</a>
                            </div>
                        </div>
                    </div>
                </div>                            
        ...
        <div class="col right">
            ...
            <div class="mx-3 mb-4">
                <div id="title" class="title d-flex justify-content-between mx-2 py-2 px-3 border-bottom">
                    ...
                    <a class="text-reset text-decoration-none fst-normal h4 mb-0 fw-bolder" href="onprocess.php">on-process</a>
