                                ...
                                <tr class="d-print-none">
                                    <td colspan="12">
                                        ...
                                        <?php 
                                            if($status == "Pending"){ 
                                        ?>
                                            <button type="submit" name="cancel" class="px-1 py-1 fs-4 me-3 border border-dark btn-pink btn-shadow">cancel</button>
                                        ...
                                        ?>
                                            <button type="submit" name="to-process" class="px-3 py-1 fs-4 border border-dark btn-pink btn-shadow" <?php echo $setstatus; ?>>to process</button>
                                        <?php 
                                            }elseif($status == "On Process"){
                                        ?>
