...
<div class="container-fluid admin p-0">
    ...
    <div class="row gx-3 pb-5 px-4" style="min-height: 800px;">
        <div class="col-3 sidebar p-0 me-3">
            ...
            <hr>
            <div class="ms-1 d-flex align-items-center">
                <a class="text-reset text-decoration-none fw-bold fs-3 ms-2 mb-1 w-100" href="admin-transaction/pending.php">
                                    ...
                                    ?>
                                        <li>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a onClick="window.location()" type="submit" href="updateproduct.php?productname=<?php echo $row['product_name']; ?>"
        ...
        <div class="col right">
            ...
            <form action="../process/update.php" method="POST">
                ...
                <div class="my-2 mx-5 border border-dark">
                    ...
                    <p class="mb-2 fs-4 ms-5 lh-sm" style="color: #7F7B7B;"><?php echo $message; ?></p>
                </div>
                <?php
                    }
                ?>
