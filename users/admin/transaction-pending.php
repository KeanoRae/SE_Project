        ...
        <div class="col right">
            ...
            <div class="mx-3 mb-4">
                <div id="title" class="title d-flex justify-content-between mx-2 py-2 px-3 border-bottom">
                    <a class="text-reset text-decoration-none fst-normal h4 mb-0 head headtag" href="#">pending</a>
                    <a class="text-reset text-decoration-none fst-normal h4 mb-0 head" href="transaction-confirmed.php">confirmed</a>
