...
<body>
    ...
    <div class="container-fluid admin p-0">
        ...
        <div class="row gx-3 mb-5 px-4" style="height: 800px;">
            ...
            <div class="col right">
                <p class="header fs-2 fw-bold mb-4 mt-5 mx-5">TRANSACTION</p>
                <div class="tmp mx-3 mb-4">
                    <div class="title d-flex justify-content-between mx-2 py-2 px-3 border-bottom">
                        <p class="fst-normal h4 mb-0">pending</p>
