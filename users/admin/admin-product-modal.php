                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div>
                                <select name="region" class="w-100 py-2 rounded">
                                    <option value="" selected disabled hidden></option>
                                    <option class="py-5">glass painting</option>
                                </select>
                            </div>                 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <div >
                                    <select name="region" class="py-2 w-100 rounded">
                                        <option value="" selected disabled hidden></option>
                                        <option>64</option>
                                        <option>65</option>
                                    </select>
                        ...
                        <div class="col-6">
                            ...
                            <div>
                                <select name="region" class="py-2 w-100 rounded">
                                    <option value="" selected disabled hidden></option>
                                    <option class="py-5">Acrylic</option>
                                </select>
                            </div>
                        </div> 
                    </div>
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select name="region" class="py-2 w-100 rounded">
                                <option value="" selected disabled hidden></option>
                                <option class="py-5">Acrylic Paint</option>
                            </select>
                        </div>
                    </div>   
                    <div class="row mt-5">
